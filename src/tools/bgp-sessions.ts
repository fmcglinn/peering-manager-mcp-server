...
export function registerBgpSessionTools(server: McpServer) {
  server.tool(
    "list_bgp_sessions",
    "List BGP sessions across both direct peering and IXP sessions. Returns unified view with common fields. Note: router_name/router_hostname filtering for IXP sessions uses best-effort search matching (may include false positives).",
    {
