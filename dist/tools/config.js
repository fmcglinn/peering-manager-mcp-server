...
export function registerConfigTools(server) {
    server.tool("get_router_configuration", "Get the rendered configuration for a specific router. Uses extended timeout due to Jinja2 rendering and possible IRR lookups.", {
